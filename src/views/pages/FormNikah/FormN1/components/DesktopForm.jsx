...
import { fillFormN1 } from "src/redux/actions/formSelesaiActions";
...
const DesktopForm = ({ onChangePage, ...rest }) => {
    ...
    const [marriedBefore, setMarriedBefore ] = useState({
        man: false,
        girl: false
    });
    ...
    //Function
    const handleChangeMarriedBefore = (event) => {
        setMarriedBefore({...marriedBefore, [event.target.name] : event.target.checked});
    }
            ...
            onSubmit={async (values, {
                ...
                try {
                    ...
                    const dataForm = {
                        ...
                        mantanIstri: values.mantanIstri || null,
                        mantanAnakPria: values.mantanAnak || null,
                        ...
                        mantanSuami: values.mantanSuami,
                        mantanAnakWanita: values.mantanAnakWanita
                    }

                    await dispatch(fillFormN1(dataForm));

                    await onChangePage("next");
                                ...
                                <CardContent className={classes.cardContent} >
                                    ...
                                    >
                                        <FormControlLabel
                                            control={
                                                <StyledSwitch
                                                    checked={marriedBefore.man}
                                                    onChange={handleChangeMarriedBefore}
                                                    name="man"
                                                />}
                                            label="Sudah Menikah"
                                    ...
                                    <TextField
                                        error={Boolean(touched.mantanIstri && errors.mantanIstri)}
                                        helperText={touched.mantanIstri && errors.mantanIstri}
                                        onBlur={handleBlur}
                                        onChange={handleChange}
                                        value={values.mantanIstri}
                                        className={classes.formInput}
                                        label="Mantan Istri"
                                        name="mantanIstri"
                                        margin="normal"
                                        type="search"
                                        variant="outlined"
                                        disabled={!marriedBefore.man}
                                        autoFocus
                                    />

                                    <TextField
                                        error={Boolean(touched.mantanAnakPria && errors.mantanAnakPria)}
                                        helperText={touched.mantanAnakPria && errors.mantanAnakPria}
                                        onBlur={handleBlur}
                                        onChange={handleChange}
                                        value={values.mantanAnakPria}
                                        className={classes.formInput}
                                        label="Anak Dari Mantan Istri"
                                        name="mantanAnakPria"
                                        margin="normal"
                                        type="search"
                                        variant="outlined"
                        ...
                        >
                            <Card className={classes.card}>
                                ...
                                <CardContent className={classes.cardContent}>
                                    ...
                                    <TextField
                                        error={Boolean(touched.mantanSuami && errors.mantanSuami)}
                                        helperText={touched.mantanSuami && errors.mantanSuami}
                                        onBlur={handleBlur}
                                        onChange={handleChange}
                                        value={values.mantanSuami}
                                        className={classes.formInput}
                                        label="Mantan Suami"
                                        name="mantanSuami"
                                        margin="normal"
                                        type="search"
                                        variant="outlined"
                                        disabled={!marriedBefore.girl}
                                        autoFocus
                                    />

                                    <TextField
                                        error={Boolean(touched.mantanAnakWanita && errors.mantanAnakWanita)}
                                        helperText={touched.mantanAnakWanita && errors.mantanAnakWanita}
                                        onBlur={handleBlur}
                                        onChange={handleChange}
                                        value={values.mantanAnakWanita}
                                        className={classes.formInput}
                                        label="Anak Dari Mantan Suami"
                                        name="mantanAnakWanita"
                                        margin="normal"
                                        type="search"
                                        variant="outlined"
                                        disabled={!marriedBefore.girl}
